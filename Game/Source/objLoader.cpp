...
#pragma endregion
	...
	if (collidableGeometryIndices != nullptr && collidableGeometryPositions != nullptr)
	{
		...
		DirectX::XMVECTOR tempVertexPosVec;
		DirectX::XMFLOAT3 tempVertF3;

		for (size_t i = 0; i < vertices.size(); i++)
		{
			tempVertexPosVec = DirectX::XMLoadFloat4(&vertices[i].position);
			tempVertexPosVec = DirectX::XMVector3TransformCoord(tempVertexPosVec, DirectX::XMLoadFloat4x4(&objMatrix));
