...
bool Direct3D::SetPixelCBuffer(ID3D11Buffer* _lightBuffers, const LightInfo &_lightInfo)
{
	return renderer->SetPixelCBuffer(deviceContext, _lightBuffers, _lightInfo);
}
